...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "24+ years of trusted real estate expertise across Delhi, Gurgaon, Noida, Greater Noida, Faridabad and Ghaziabad. Buy, rent or list with Zero9Home." },
      { name: "author", content: "Zero9Home" },
      { property: "og:title", content: "Zero9Home.com — Curating Delhi NCR's Finest Homes" },
      { property: "og:description", content: "24+ years of trusted real estate expertise across Delhi, Gurgaon, Noida, Greater Noida, Faridabad and Ghaziabad. Buy, rent or list with Zero9Home." },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@400;500;600;700&family=Inter:wght@300;400;500;600;700&family=JetBrains+Mono:wght@400;500;600&display=swap",
      },
    ],
  }),
